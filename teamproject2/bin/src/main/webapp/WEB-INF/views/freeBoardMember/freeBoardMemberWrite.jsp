		 ...
		 -->		<div id="body_list">
					<article >
						<div id="write_div">
						  ...
						  <form class="" action="freeBoardMemberWrite" method="post" enctype="multipart/form-data" id = "memberForm">
							  ...
							  <input type="text" id="input_title" class="input_class" name="fbm_title" value="" placeholder="제목을 입력해주세요">
							  </div>
				  
							  <div class="write_class">
								<label for="input_name" class="write_label">작성자</label><br>
								<input type="text" id="input_name" class="input_class" name="fbm_nickname" value="${session_nickname }" disabled="disabled">
							  </div>
				  
							  <div class="write_class" id="content_div">
								<label for="f_content" class="write_label">내용</label><br>
								<textarea name="fbm_content" cols="80" id="input_content" placeholder="내용을 입력해주세요" ></textarea>
							  </div>
				...
				<div id="footer_div_btn">
					<button type="button" class="btn btn-outline-secondary" id="btn_save" onclick = "writeBoardMember()" >저장</button>
