		 ...
		 -->		<div id="body_list">
					<article >
						<div id="write_div">
						  ...
						  <form class="" action="noriBoardWrite" method="post" enctype="multipart/form-data" id = "noriForm">
							  ...
							  <label for="input_title" class="write_label">종목</label><br>
								  <select name = "nb_category" id = "nb_category">
							  ...
							  <input type="text" id="input_title" class="input_class" name="nb_title" value="" placeholder="제목을 입력해주세요">
							  </div>
				  
							  <div class="write_class">
								<label for="input_name" class="write_label">작성자</label><br>
								<input type="text" id="input_name" class="input_class" name="nb_nickname" value="${session_nickname }" disabled="disabled">
							  </div>
				  
							  <div class="write_class" id="content_div">
								<label for="nb_content" class="write_label">내용</label><br>
								<textarea name="nb_content" cols="80" id="input_content" placeholder="내용을 입력해주세요" ></textarea>
							  </div>
				...
				<div id="footer_div_btn">
					<button type="button" class="btn btn-outline-secondary" id="btn_save" onclick = "writeNoriBoard()" >저장</button>
					<button type="button" class="btn btn-outline-secondary" id="btn_cancle" onclick = "returnNoriBoardList()">취소</button>
				</div>
		</div>
		<div id="footer_div">
