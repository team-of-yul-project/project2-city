      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <span class="ml-2 d-none d-lg-inline text-white small">관리자 아이디</span>
              </a>
        ...
        <DIV>
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">회원 목록 현황</h6>
          </div>
          <div class="table-responsive p-3">
            ...
            <c:forEach items="${list }" var="memberVo">
                <tr>
                  <td>${memberVo.m_No }</td>
                  <td>${memberVo.m_id }</td>
                  <td>${memberVo.m_Nickname }</td>
                  <td>${memberVo.m_Add1 }</td>
                  <td>${memberVo.m_Email }</td>
                  <td>${memberVo.m_hit }</td>
                  <td><a href="#">VIEW</a></td>
                </tr>
