...
function returnFreeBoardView(){
	location.href = "noticeBoardView?n_num=${param.n_num}&page=${param.page }&searchCategory=${param.searchCategory}&sportsCategory=${param.sportsCategory }&searchWord=${param.searchWord}";
}
		 ...
		 -->		<div id="body_list">
					<article >
						<div id="write_div">
						  ...
						  <form class="" action="noticeBoardModify" method="post" id = "modifyForm" enctype="multipart/form-data">
						  <input type = "hidden" name = "n_num" value = "${param.n_num }">
							  ...
							  <input type="text" id="input_title" class="input_class" name="n_title" value="${map.noticeBoardrVo.n_title}" >
							  </div>
				  
							  <div class="write_class">
								<label for="input_name" class="write_label">작성자</label><br>
								<input type="text" id="input_name" class="input_class" name="n_nickname" value="${map.noticeBoardrVo.m_nickname }" disabled="disabled">
							  </div>
				  
							  <div class="write_class" id="content_div">
								<label for="fbm_content" class="write_label">내용</label><br>
								<textarea name="n_content" cols="80" id="input_content" placeholder="" >${map.noticeBoardrVo.n_content }</textarea>
							  </div>
