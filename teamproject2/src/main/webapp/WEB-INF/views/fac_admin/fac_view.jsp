                ...
                <div id="fac_inform_input1">
                  <form>
                    <div class="form-group" id="fac_input">
                      ...
                      <input type="text" class="form-control" placeholder="시설 종목">
                      ...
                      <input type="text" class="form-control" placeholder="최대 인원">
                    ...
                    <a href="fac_modify" class="btn btn-primary" id="fac_save">수정</a>
