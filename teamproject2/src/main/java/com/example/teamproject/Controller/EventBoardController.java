...
//	게시판 페이지 오픈
	...
	public String openEventBoardList(@RequestParam(value = "searchCategory") @Nullable String searchCategory,
			@RequestParam(defaultValue = "") String sportsCategory, @RequestParam(defaultValue = "") String searchWord,
			@RequestParam(defaultValue = "1") int page, Model model) {
		Map<String, Object> map = eventBoardService.selectEventBoardList(searchCategory, sportsCategory, searchWord,
				page);
...
//	게시판 쓰기 오픈
	...
	public String openEventBoardWrtie() {
